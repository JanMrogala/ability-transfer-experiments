#!/bin/bash
#SBATCH --job-name=tokenize_data                            # Job name
#SBATCH --output=logs/tokenize_data/tokenize_data_%j.out        # Standard output and error log (%j expands to jobID)
#SBATCH --error=logs/tokenize_data/tokenize_data_%j.err         # Error log
