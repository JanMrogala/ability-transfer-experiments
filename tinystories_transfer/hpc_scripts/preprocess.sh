...
#SBATCH --output=logs/preprocess/preprocess_%j.out        # Standard output and error log (%j expands to jobID)
#SBATCH --error=logs/preprocess/preprocess_%j.err         # Error log
